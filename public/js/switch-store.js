(function(){
  ...
  window.OSCSwitchStore={read,write,addTransaction,closeBatch,reconcileATM,generateClearing,setAtmMessages,setLastAtmReconciliation,addConstructorPractice,addIsoMessage,flush,reset,ready,key:KEY};
})();
